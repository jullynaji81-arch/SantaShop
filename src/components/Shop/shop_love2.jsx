      ...
      <div className="shopping__header">
        ...
        <div className="shopping__grid">
          <div className="shopping__card">
            <h3>$10.75</h3>
            <img src="assets/love1.jfif" alt="shopping" className='doz'/>
            <h4>Drum Decors</h4>
          </div>
          <div className="shopping__card">
            <h3>$75.50</h3>
            <img src="assets/love2.jfif" alt="shopping" className='doz' />
            <h4>Bell Decors</h4>
          </div>
          <div className="shopping__card">
            <h3>$20.00</h3>
            <img src="assets/love3.jfif" alt="shopping" className='doz' />
            <h4>Santa Cap Pack</h4>
          </div>
          <div className="shopping__card">
            <h3>$112.00</h3>
            <img src="assets/love4.jfif" alt="shopping" className='doz' />
            <h4>Gift Decors</h4>
          </div>
        </div>
      </div>
